...
HD_PWD='C:/ece532/nexys3_ise_gpio_uart/auto_parking/auto_parking.runs/design_1_rst_mig_7series_0_81M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_mig_7series_0_81M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_mig_7series_0_81M_2.tcl
