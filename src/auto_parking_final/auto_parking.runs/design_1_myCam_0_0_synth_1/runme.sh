...
HD_PWD='D:/Work/UofT/ECE532/auto_parking/auto_parking.runs/design_1_myCam_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myCam_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myCam_0_0.tcl
