...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller is
  ...
  signal I2C_BIT_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of ACKR3_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of ACKR3_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of ACKW3_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of END_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of END_i_5 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of I2C_BIT_i_10 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of I2C_BIT_i_22 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of OV7670_SIOC_INST_0_i_4 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of OV7670_SIOC_INST_0_i_5 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of OV7670_SIOD_INST_0_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \SD_COUNTER[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \SD_COUNTER[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \SD_COUNTER[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \SD_COUNTER[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \SD_COUNTER[5]_i_5\ : label is "soft_lutpair4";
...
ACKR1_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFDFFFEFFFFFFFE"
    )
        port map (
...
I2C_BIT_i_22: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
I2C_BIT_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"02A2"
    )
        port map (
...
I2C_BIT_i_39: unisim.vcomponents.LUT5
    generic map(
      INIT => X"CC1DFF1D"
    )
        port map (
...
I2C_BIT_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
I2C_BIT_i_54: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_OV7670_RGB444_Config is
  ...
  signal I2C_BIT_reg_i_62_n_0 : STD_LOGIC;
  signal I2C_BIT_reg_i_63_n_0 : STD_LOGIC;
  signal I2C_BIT_reg_i_64_n_0 : STD_LOGIC;
  signal I2C_BIT_reg_i_65_n_0 : STD_LOGIC;
  signal I2C_BIT_reg_i_66_n_0 : STD_LOGIC;
  signal I2C_BIT_reg_i_67_n_0 : STD_LOGIC;
  signal I2C_BIT_reg_i_68_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of I2C_BIT_i_75 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of I2C_BIT_i_85 : label is "soft_lutpair10";
begin
...
I2C_BIT_i_106: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000200"
    )
        port map (
...
I2C_BIT_i_110: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000100"
    )
        port map (
...
I2C_BIT_i_57: unisim.vcomponents.LUT6
    generic map(
...
I2C_BIT_i_75: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
I2C_BIT_i_85: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
I2C_BIT_reg_i_23: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_46_n_0,
      I1 => I2C_BIT_i_47_n_0,
      O => I2C_BIT_reg_11,
...
I2C_BIT_reg_i_24: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_48_n_0,
      I1 => I2C_BIT_i_49_n_0,
      O => I2C_BIT_reg_9,
...
I2C_BIT_reg_i_29: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_55_n_0,
      I1 => I2C_BIT_i_56_n_0,
      O => I2C_BIT_reg_5,
...
I2C_BIT_reg_i_30: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_57_n_0,
      I1 => I2C_BIT_i_58_n_0,
      O => I2C_BIT_reg_14,
...
I2C_BIT_reg_i_31: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_59_n_0,
      I1 => I2C_BIT_i_60_n_0,
      O => I2C_BIT_reg_0,
...
I2C_BIT_reg_i_32: unisim.vcomponents.MUXF8
     port map (
      I0 => I2C_BIT_reg_i_61_n_0,
      I1 => I2C_BIT_reg_i_62_n_0,
      O => data16,
      S => Q(7)
    );
I2C_BIT_reg_i_33: unisim.vcomponents.MUXF8
     port map (
      I0 => I2C_BIT_reg_i_63_n_0,
      I1 => I2C_BIT_reg_i_64_n_0,
      O => data17,
      S => Q(7)
    );
I2C_BIT_reg_i_34: unisim.vcomponents.MUXF8
     port map (
      I0 => I2C_BIT_reg_i_65_n_0,
      I1 => I2C_BIT_reg_i_66_n_0,
      O => data18,
      S => Q(7)
    );
I2C_BIT_reg_i_35: unisim.vcomponents.MUXF8
     port map (
      I0 => I2C_BIT_reg_i_67_n_0,
      I1 => I2C_BIT_reg_i_68_n_0,
      O => data19,
      S => Q(7)
    );
...
I2C_BIT_reg_i_63: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_99_n_0,
...
I2C_BIT_reg_i_64: unisim.vcomponents.MUXF7
     port map (
      I0 => I2C_BIT_i_101_n_0,
      I1 => I2C_BIT_i_102_n_0,
      O => I2C_BIT_reg_i_64_n_0,
      S => Q(4)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vga444 is
  ...
  attribute SOFT_HLUTNM of \hCounter[2]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \hCounter[3]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \hCounter[4]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \hCounter[5]_i_2\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \hCounter[5]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \hCounter[8]_i_2\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \hCounter[9]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \pixal_count[0]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \pixal_count[0]_i_5\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \vCounter[0]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \vCounter[1]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \vCounter[2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \vCounter[3]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \vCounter[3]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \vCounter[4]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \vCounter[7]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \vCounter[8]_i_2\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \vCounter[9]_i_4\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \vga_blue[0]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \vga_blue[1]_i_1\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \vga_blue[3]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \vga_blue[3]_i_4\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \vga_blue[3]_i_5\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \vga_green[2]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \vga_green[3]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of vga_hsync_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \vga_red[0]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \vga_red[1]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \vga_red[2]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \vga_red[3]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \vga_red[3]_i_4\ : label is "soft_lutpair33";
begin
  LED(0) <= \^led\(0);
...
\hCounter[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
\hCounter[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6066666666666666"
    )
        port map (
      I0 => \hCounter[9]_i_4_n_0\,
      I1 => \hCounter_reg_n_0_[8]\,
      I2 => \hCounter_reg_n_0_[6]\,
      I3 => \hCounter[8]_i_2_n_0\,
      I4 => \hCounter[8]_i_3_n_0\,
      I5 => \hCounter_reg_n_0_[9]\,
      O => hCounter(8)
    );
\hCounter[8]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\hCounter[8]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00200000"
    )
        port map (
...
\pixal_count[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \pixal_count[0]_i_3_n_0\,
      I2 => \pixal_count[0]_i_4_n_0\,
      I3 => \vCounter_reg_n_0_[6]\,
      I4 => \vCounter_reg_n_0_[5]\,
      I5 => \pixal_count[0]_i_5_n_0\,
      O => \pixal_count[0]_i_1_n_0\
    );
\pixal_count[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEFFFFF"
    )
        port map (
...
\pixal_count[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\pixal_count[0]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\pixal_count_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \pixal_count[0]_i_6_n_0\,
      S(2) => \pixal_count[0]_i_7_n_0\,
      S(1) => \pixal_count[0]_i_8_n_0\,
      S(0) => \pixal_count[0]_i_9_n_0\
    );
...
\vga_blue[3]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEEFFF"
    )
        port map (
      I0 => \vga_blue[3]_i_6_n_0\,
...
u_I2C_Controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller
     port map (
      ...
      \LUT_INDEX_reg_rep[2]\ => u_I2C_OV7725_RGB444_Config_n_28,
      ...
      \LUT_INDEX_reg_rep[2]_5\ => u_I2C_OV7725_RGB444_Config_n_27,
      ...
      \LUT_INDEX_reg_rep[5]\ => u_I2C_OV7725_RGB444_Config_n_7,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myCam_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_2\ : label is "soft_lutpair43";
